...
public class FrontActivityAdapter extends RecyclerView.Adapter<FrontActivityAdapter.ViewHolder> {

    ArrayList<String> alName;
    ArrayList<Integer> alImage;
    Context context;

    public FrontActivityAdapter(Context context, ArrayList<String> alName, ArrayList<Integer> alImage) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.front_activity_topics, viewGroup, false);
